...
public final class ToastUtils {
    ...
    private static int yOffset = (int) (64 * NApplication.getContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(NApplication.getContext().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(NApplication.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(NApplication.getContext(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(NApplication.getContext());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        ...
        LayoutInflater inflate = (LayoutInflater) NApplication.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
