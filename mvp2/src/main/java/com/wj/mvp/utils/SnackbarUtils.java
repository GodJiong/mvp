...
//     * @param message 信息
//     */
//    public static void topSnackbar(Activity activity, String message) {
//        TSnackbar snackbar = TSnackbar.make(activity.findViewById(android.R.id.content), message, TSnackbar.LENGTH_LONG);
//        View snackbarView = snackbar.getView();
//        snackbarView.setBackgroundColor(Color.parseColor("#FF6C6C"));
//        snackbarView.setPadding(10, 40, 0, 0);
